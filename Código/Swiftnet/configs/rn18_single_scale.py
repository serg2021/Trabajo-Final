...
root = Path.home() / Path('Desktop/Trabajo-Final/Código/Swiftnet/datasets/ISA2/Urban/U3')
...
if evaluating:
    loader_train = DataLoader(dataset_train, batch_size=14, collate_fn=custom_collate)
else:
